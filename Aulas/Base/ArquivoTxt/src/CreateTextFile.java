...
public class CreateTextFile
{
    ...
    public static void openFile()
    {
        try
        {
            output = new Formatter("clients.txt"); // abre o arquivoÿ
        }
    ...
    public static void addRecords()
    {
        ...
        //for (input.hasNext()) // faz um loop até o indicador de fim de arquivo
        if (input.hasNext()) // faz um loop até o indicador de fim de arquivo
