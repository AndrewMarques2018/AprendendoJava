...
import javax.swing.event.ListSelectionListener;
         ...
         public class ListFrame extends JFrame
 {
         ...
         colorJList = new JList<String>(colorNames); // lista de colorNamesÿ
         colorJList.setVisibleRowCount(5); // exibe cinco linhas de uma vezÿ

         // não permite múltiplas seleções
         colorJList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

         // adiciona um JScrollPane que contém JList ao frameÿ
