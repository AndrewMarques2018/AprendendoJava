         ...
         public class RadioButtonFrame extends JFrame
 {
         ...
         private final JRadioButton plainJRadioButton; // seleciona texto simples ÿ
         private final JRadioButton boldJRadioButton; // seleciona texto em negrito ÿ
         private final JRadioButton italicJRadioButton; // seleciona texto em itálicoÿ
         private final JRadioButton boldItalicJRadioButton; // negrito e itálico ÿ
         private final ButtonGroup radioGroup; // contém botões de opção ÿ
         ...
         // cria relacionamento lógico entre JRadioButtons ÿ
         radioGroup = new ButtonGroup(); // cria ButtonGroup ÿ
         radioGroup.add(plainJRadioButton); // adiciona texto simples ao grupoÿ
         radioGroup.add(boldJRadioButton); // adiciona negrito ao grupo ÿ
         radioGroup.add(italicJRadioButton); // adiciona itálico ao grupo ÿ
         radioGroup.add(boldItalicJRadioButton); // adiciona negrito e itálicoÿ
